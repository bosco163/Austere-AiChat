<h1 align="center">Austere AiChat </h1>v3.2
<p align="center"><em>极简单文件 · 极致简体验</em></p>

---

## 简介

**Austere AiChat** 是一款设计理念为 **简洁但不简单** 的网页AI聊天应用。整个系统仅由一个 PHP 文件构成（不到80KB），无需数据库，无需复杂配置，开箱即用。尽管代码极度精简，却提供了媲美商业产品的完整功能：多模型支持、实时流式对话、图片/文件分析、历史会话管理、全文搜索、数学公式渲染、Mermaid图表等。
...
> **致老用户**：此前的版本因 AI 生成代码质量不稳定，越改 Bug 越多，导致项目长时间停滞。本次 v3.0（v3.2修复了bug，优化了体验）彻底重构，采用更严格的代码审查策略，终于达到了可发布标准。

**特别致谢参与的 AI 模型**：
- **GLM-5 和 Kimi-K2.5** 和 （主力开发，承担大部分代码生成与 Debug）
